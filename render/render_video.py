...
def _ai_pick_transitions(clips, shot_plan) -> list:
    ...
    try:
        ...
        prompt = (
            ...
            "abrupt — prefer fade / dissolve there. In a mellow montage, soft transitions "
            "are the workhorse and will usually be the majority.\n"
            "- hblur is a SPEED effect: it only works when at least one side has fast motion or "
            "the music hits hard at the boundary. On calm/mellow music it feels jarring — for "
            "this kind of montage use fade/dissolve/cut almost exclusively (user preference).\n"
